          ...
          <div class="d-flex gap-3 mt-4">
            <form @submit.prevent="submitAddcart">
              <div class="d-flex gap-3 flex-wrap">
                <label :class="{ 'disabled-opacity': durationDisabled }" v-for="duration in durations" :key="duration.id">
                  <input
                    v-model="durationValue"
                    type="radio"
                    class="input-radio input-appointment"
                    name="input-appointment"
                    :id="duration.id"
                    :value="duration.id"
                    :disabled="durationDisabled"
                    >
                  <label class="button-all button-appointment" :for="duration.id">{{ duration.day }} {{ duration.discrimination }}</label>
                </label>
